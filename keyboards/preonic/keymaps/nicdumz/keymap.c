...
[_LOWER] = {
  ...
  {CTL_T(KC_DLR), KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS, _______, _______, _______, _______},
...
[_RAISE] = {
  ...
  {ALL_T(KC_TILD), KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LCBR, KC_RCBR, KC_DEL},
  {_______,        _______, _______, _______, _______, _______, KC_UNDS, KC_MINS, KC_PLUS, KC_LBRC, KC_RBRC, KC_PIPE},
